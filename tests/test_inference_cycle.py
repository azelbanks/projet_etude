        ...
        with patch("builtins.open", mock_open()):
            with patch.dict(
                "sys.modules",
                {
                    ...
                    "joblib": MagicMock(
                        **{"load.return_value": {"pipeline": MagicMock(), "threshold": 0.45}}
                    ),
                    "pipeline": MagicMock(),
...
class TestRunInferenceCycle:
    ...
    @patch("collection.collect_bluesky._load_inference_models")
    def test_no_documents_returns_early(self, mock_load, mock_model, mock_detector, mock_le):
    ...
    @patch("collection.collect_bluesky._emotion_le")
    @patch(
        "collection.collect_bluesky._emotion_vocab",
        {"<PAD>": 0, "<UNK>": 1, "hello": 2, "world": 3},
    )
    @patch("collection.collect_bluesky._detector")
    @patch("collection.collect_bluesky._emotion_model")
    @patch("collection.collect_bluesky._load_inference_models")
    def test_full_cycle_without_stage1(self, mock_load, mock_model, mock_detector, mock_le):
    ...
    @patch("collection.collect_bluesky._emotion_max_len", 5)
    @patch("collection.collect_bluesky._emotion_le")
    @patch("collection.collect_bluesky._emotion_vocab", {"<PAD>": 0, "<UNK>": 1, "test": 2})
    @patch("collection.collect_bluesky._detector")
    @patch("collection.collect_bluesky._emotion_model")
    @patch("collection.collect_bluesky._load_inference_models")
    def test_full_cycle_with_stage1(self, mock_load, mock_model, mock_detector, mock_le):
    ...
    @patch("collection.collect_bluesky._emotion_max_len", 5)
    @patch("collection.collect_bluesky._emotion_le")
    @patch("collection.collect_bluesky._emotion_vocab", {"<PAD>": 0, "<UNK>": 1, "fact": 2})
    @patch("collection.collect_bluesky._detector")
    @patch("collection.collect_bluesky._emotion_model")
    @patch("collection.collect_bluesky._load_inference_models")
    def test_stage1_factuel_keeps_v5_label(self, mock_load, mock_model, mock_detector, mock_le):
    ...
    @patch("collection.collect_bluesky._emotion_model")
    @patch("collection.collect_bluesky._load_inference_models")
    def test_empty_batch_breaks_loop(self, mock_load, mock_model, mock_detector, mock_le):
    ...
    @patch("collection.collect_bluesky._emotion_model")
    @patch("collection.collect_bluesky._load_inference_models")
    def test_text_truncated_to_max_len(self, mock_load, mock_model, mock_detector, mock_le):
    ...
    @patch("collection.collect_bluesky._emotion_le")
    @patch("collection.collect_bluesky._emotion_vocab", {"<PAD>": 0, "<UNK>": 1, "hi": 2})
    @patch("collection.collect_bluesky._detector")
    @patch("collection.collect_bluesky._emotion_model")
    @patch("collection.collect_bluesky._load_inference_models")
    def test_short_text_padded_to_max_len(self, mock_load, mock_model, mock_detector, mock_le):
    ...
    @patch("collection.collect_bluesky._emotion_max_len", 5)
    @patch("collection.collect_bluesky._emotion_le")
    @patch("collection.collect_bluesky._emotion_vocab", {"<PAD>": 0, "<UNK>": 1, "opinion": 2})
    @patch("collection.collect_bluesky._detector")
    @patch("collection.collect_bluesky._emotion_model")
    @patch("collection.collect_bluesky._load_inference_models")
    def test_stage1_exception_handled_gracefully(
        self, mock_load, mock_model, mock_detector, mock_le
    ):
    ...
    @patch("collection.collect_bluesky._emotion_model")
    @patch("collection.collect_bluesky._load_inference_models")
    def test_opinion_suspicious_reclassified_to_reliable(
        self, mock_load, mock_model, mock_detector, mock_le
    ):
