...
class StyleFeatureExtractorV6:
    ...
    FEATURE_LABELS_FR = {
        ...
        "punct_density": "Densit\u00e9 ponctuation",
        "ellipsis_count": "Points de suspension",
        "repeated_punct_ratio": "Ponctuation r\u00e9p\u00e9t\u00e9e",
        "emoji_count": "Emojis",
        ...
        "call_to_action_score": "Appel \u00e0 l'action",
        "hedging_score": "Langage \u00e9vasif",
        "authority_claim_score": "Appel \u00e0 l'autorit\u00e9",
        "has_url": "Pr\u00e9sence URL",
        "has_source_citation": "Citation de source",
        "numeric_density": "Densit\u00e9 num\u00e9rique",
        "quote_count": "Citations/guillemets",
        "named_entity_density": "Densit\u00e9 entit\u00e9s nomm\u00e9es",
        "lexical_diversity": "Diversit\u00e9 lexicale (TTR)",
        "repeated_char_ratio": "Caract\u00e8res r\u00e9p\u00e9t\u00e9s",
    ...
    def extract(cls, texts) -> np.ndarray:
        ...
        for i, text in enumerate(texts):
            ...
            if len(words) > 1:
                ne_count = sum(
                    1 for j, w in enumerate(words[1:], 1) if w[0].isupper() and w.isalpha()
                )
