...
|
|-- WP8 : Video MVP (Avril 2026)
|   |-- T8.1 : Script et storyboard
|   |-- T8.2 : Tournage demo live
|   |-- T8.3 : Montage et post-production
|   |-- T8.4 : Livraison finale
```
...
```
Tache                          | Dec 25  | Jan 26  | Fev 26  | Mars 26 | Avril 26|
                               | S1 S2 S3| S4 S5 S6| S7 S8 S9|S10S11S12|S13S14S15|
-------------------------------|---------|---------|---------|---------|---------|
WP1 Cadrage & Infra            |[========]         |         |         |         |
...
- `[===]` : Duree de la tache
- S1-S15 : Semaines (Dec 2025 Semaine 1 a Avril 2026 Semaine 15)
...
| 25/04/2026 | J16 - Documentation finale | Rapport, docs PDF, planification | Azelie |
| 28/04/2026 | J17 - Video MVP | Video 15 min + dossier technique | Azelie + Sebastien |
...
| T8.1 Video | T7.3 Rapport | Fin-Debut | Oui |
...
```
T1.3 -> T1.4 -> T2.1 -> T4.1 -> T4.2 -> T4.3 -> T4.4 -> T4.5 -> T4.6 -> T4.7 -> T7.3 -> T8.1
```

Duree totale du chemin critique : **~20 semaines** (Dec 2025 - Avril 2026)
...
| WP4 Pipeline NLP | 80 | 10 | 90 |
| WP5 Transformers | 40 | 0 | 40 |
| WP6 Dashboard | 30 | 0 | 30 |
| WP7 Documentation | 40 | 5 | 45 |
| WP8 Video MVP | 10 | 10 | 20 |
| **Total** | **275** | **25** | **300** |
...
*Reference : PLAN-THUM-2026-001 - Version 1.0*
