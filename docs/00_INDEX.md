...
| D08 | Index General (ce document) | IDX-THUM-2026-001 | 1.0 | En vigueur | `docs/00_INDEX.md` |
...
| V3 | T3 2026 (planifie) | Planifie | Cible > 0.90 courts | — | Sentence-Transformers, embeddings 384D |
| V4 | T4 2026 (planifie) | Planifie | Cible > 0.92 | — | Fine-tuning CamemBERT / RoBERTa |

---

*Document mis a jour le 3 avril 2026*
*Reference : IDX-THUM-2026-001 -- Version 1.0*
