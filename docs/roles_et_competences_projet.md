...
**Taches** :
- Concevoir des analyses exploratoires avancees sur les 537 000+ posts collectes (collecte continue) : clustering thematique (LDA, BERTopic), detection de communautes, evolution temporelle des sujets
