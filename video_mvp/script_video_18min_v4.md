# Script video 18 min — ThumaCheck (v4 client)
...
> **Changements v3 -> v4** :
> - Chiffres corriges (537 tests, 465 gold set, 17 features linguistiques)
> - Ton recentre 100% client Thumalien (moins de jargon ML, plus de benefices)
> - Module emotions rendu visible (exigences EMO-01 a EMO-05 du CDC)
> - Securite mentionnee (exigences SEC-01 a SEC-04 du CDC)
> - Mode demo mentionne (exigence DASH-05 du CDC)
> - F1 gold 0.67 contextualise (kappa, subjectivite, outil d'aide)
> - XAI vulgarise pour audience non-technique
> - AI Act : date effective aout 2026, classification art. 50 risk limite
> - RGPD : droit a l'effacement operationnel (< 5s)
...
|---------|----------|-------|
| **Azelie** | Hook + Contexte client + Architecture + Demo dashboard + Emotions + XAI + Conclusion | ~9 min |
| **Sebastien** | Equipe + Problematique + Iterations + Qualite industrielle + Securite + Conformite + Green IT + Methodologie + Limites + ROI | ~9 min |
...
> J'ai pilote l'annotation du gold set — 465 textes Bluesky annotes
...
> Ce qui distingue ThumaCheck d'un outil boite noire :
> trois niveaux d'explication.
>
> Premier niveau : les mots les plus influents.
> Ce n'est pas une approximation —
> c'est la formule exacte du modele.
>
> Deuxieme niveau : l'analyse du style d'ecriture.
> La presence de citations et la diversite du vocabulaire
> confirment un contenu fiable.
>
> Troisieme niveau : la decomposition complete de la decision.
> On lit le poids de chaque critere, coefficient par coefficient.
>
...
### 12:00 - 13:30 — Qualite industrielle + Securite (Sebastien)
...
> Nous sommes a votre disposition pour vos questions."*
...
| Contexte client + besoin + mode demo | **Azelie** | 1:00 | 1 |
...
| Demo dashboard + emotions | **Azelie** | 3:00 | — (screencast) |
| XAI + faithfulness | **Azelie** | 2:30 | 8, 9 |
| Qualite industrielle + securite | **Sebastien** | 1:30 | 10 |
...
3. Section qualite industrielle + securite (12:00-13:30) — 2 prises
...
4. Section demo dashboard + emotions (06:30-09:30) — 3 prises (la demo peut rater)
...
*Script video Thumalien V9 — v4 client — Juillet 2026*
